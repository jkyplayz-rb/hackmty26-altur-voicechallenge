...
# Asumiendo que tu archivo de VAD se llama vad_2.py
...
def extract_spectral_features_from_audio(audio_bytes):
    ...
    # Extracción de Pitch (pyin emite advertencias en silencios, las suprimimos)
    ...
    # Desempaquetar los 13 coeficientes MFCC individualmente
    for i in range(1, 14):
...
def predict_spectral(audio_bytes):
    ...
    # .get() previene errores si un modelo viejo no tiene las nuevas features
